...
# in order to get the 'send email' use case working end to end. I wrote a small sample, stitching together the Gmail API's 
# samples with a little bit of extra glue. I also inject an HTML file as an inline html body.
#
